...
import kr.co.bepo.deliverytracker.databinding.FragmentAddTrackingItemBinding
...
class AddTrackingItemFragment : ScopeFragment(), AddTrackingItemsContract.View {
    ...
    private fun bindView() {
        binding?.chipGroup?.setOnCheckedChangeListener { group, checkId ->
            presenter.changeSelectedShippingCompany(group.findViewById<Chip>(checkId).text.toString())
        }
